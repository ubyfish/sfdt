...
Thanks!`;
        ...
        //             emailSubject: 'Your new Scratch Org',
        //             senderType: 'CurrentUser',
        //         },
        //     ],
        // });    
        // let url: '/services/data/v54.0/actions/standard/emailSimple';
        // console.log('payload -> ' + payload);
        // console.log('url -> ' + url);
        // await hubOrg.getConnection().requestPost(url,payload);
                ...
                inputs: [
                    {
                        ...
                        //senderType: 'CurrentUser',
                        senderAddress: 'sfdt@example.com'
                    },
                ],
            }),
        });
